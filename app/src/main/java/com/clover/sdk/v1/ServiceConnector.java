...
import com.clover.sdk.v1.tender.*;
import com.clover.sdk.v3.*;
import com.clover.sdk.v3.remotepay.ResultStatus;
...
public abstract class ServiceConnector<S extends IInterface> implements ServiceConnection {
  ...
  protected Intent getStartIntent() {
    ...
    intent.putExtra(com.clover.sdk.v1.Intents.EXTRA_ACCOUNT, mAccount);
    intent.putExtra(com.clover.sdk.v1.Intents.EXTRA_VERSION, getServiceIntentVersion());
  ...
  protected synchronized S waitForConnection() throws com.clover.sdk.v1.BindingException {
    ...
    if (service == null) {
      throw new com.clover.sdk.v1.BindingException("Could not bind to Android service");
    }
  ...
  protected void execute(ServiceRunnable<S> runnable) throws RemoteException, com.clover.sdk.v1.ClientException, com.clover.sdk.v1.ServiceException, com.clover.sdk.v1.BindingException {
  ...
  protected <T> T execute(ServiceCallable<S, T> callable) throws RemoteException, com.clover.sdk.v1.ClientException, com.clover.sdk.v1.ServiceException, com.clover.sdk.v1.BindingException {
    if (Thread.currentThread() == Looper.getMainLooper().getThread()) {
      throw new IllegalThreadStateException("service invoked on main thread");
    }
