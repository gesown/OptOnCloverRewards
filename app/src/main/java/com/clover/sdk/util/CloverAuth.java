...
public class CloverAuth {
  ...
  public static AuthResult authenticate(Activity activity, Account account, boolean forceValidateToken, Long timeout, TimeUnit unit) throws OperationCanceledException, AuthenticatorException, IOException {
    ...
    options.putBoolean(com.clover.sdk.util.CloverAccount.KEY_FORCE_VALIDATE, forceValidateToken);
    AccountManager accountManager = AccountManager.get(activity);
    AccountManagerFuture<Bundle> future = accountManager.getAuthToken(account, com.clover.sdk.util.CloverAccount.CLOVER_AUTHTOKEN_TYPE, options, activity, null, null);
    Bundle result;
  ...
  public static AuthResult authenticate(Context context, Account account, boolean forceValidateToken, Long timeout, TimeUnit unit) throws OperationCanceledException, AuthenticatorException, IOException {
    ...
    AccountManagerFuture<Bundle> future = accountManager.getAuthToken(account, com.clover.sdk.util.CloverAccount.CLOVER_AUTHTOKEN_TYPE, options, false, null, null);
    Bundle result;
    if (timeout != null && unit != null) {
      Log.d(TAG, "Getting result with timeout " + timeout + " (" + unit + ")");
      result = future.getResult(timeout, unit);
   ...
   */
  public static AuthResult authenticate(final Context context, boolean forceValidateToken, Long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException {
    ...
    Future<AuthResult> future = exec.submit(new Callable<AuthResult>() {
      @Override
  ...
  public static class AuthResult {
    ...
    public AuthResult(Bundle authData) {
      ...
      baseUrl = authData.getString(com.clover.sdk.util.CloverAccount.KEY_BASE_URL);
      merchantId = authData.getString(com.clover.sdk.util.CloverAccount.KEY_MERCHANT_ID);
      appId = authData.getString(com.clover.sdk.util.CloverAccount.KEY_APP_ID);
